  ...
  return (
    <div className="max-w-lg mx-auto mt-10 p-6 bg-white shadow-lg rounded-lg">
      ...
      <div className="mt-6 flex justify-between">
        <button className="bg-green-500 text-white px-4 py-2 rounded-full">Proceed to Checkout</button>
        <button className="bg-gray-300 text-black px-4 py-2 rounded-full">Continue Shopping</button>
      </div>
    </div>
  );
};
